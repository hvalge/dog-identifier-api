...
func TestIsImageOfDogHandler(t *testing.T) {
    ...
    tests := []struct {
	...
	}{
		{
			...
			in:             httptest.NewRequest("GET", "/isImageOfDog?imageUrl=https://image.shutterstock.com/image-photo/golden-retriever-dog-lying-against-260nw-1093957301.jpg", nil),
		...
		},
        {
			...
			in:             httptest.NewRequest("GET", "/isImageOfDog?imageUrl=https://cdn.pixabay.com/photo/2015/04/19/08/32/marguerite-729510_960_720.jpg", nil),
			out:            httptest.NewRecorder(),
			expectedStatus: http.StatusOK,
		...
		},
        {
			...
			in:             httptest.NewRequest("GET", "/isImageOfDog?imageUrl=about://www.google.com", nil),
			out:            httptest.NewRecorder(),
		...
		},
        {
			...
			in:             httptest.NewRequest("GET", "/isImageOfDog?imageUrl=https://www.googleidsuhfgoijk.com", nil),
			out:            httptest.NewRecorder(),
			expectedStatus: http.StatusBadRequest,
		...
		},
        {
			...
			in:             httptest.NewRequest("GET", "/isImageOfDog?imageUrl=https://www.google.com", nil),
			out:            httptest.NewRecorder(),
			expectedStatus: http.StatusBadRequest,
